...
const steps = [
  ...
  },
  {
    ...
    body: [
      "The running style classifications, pace scenarios, probability weightings, and runner profiles are all produced by a systematic data engine. The written analysis — the pace dynamic narrative, scenario descriptions, runner notes and watch points — is then generated by Claude (Anthropic's AI) based on that structured output.",
      "This means the language is AI-generated, but it is grounded in the data. Claude is not making predictions or expressing opinions — it is translating what the model has computed into plain English. No tips, no recommendations, and no information beyond what the underlying analysis contains.",
    ],
  },
  {
    number: "05",
